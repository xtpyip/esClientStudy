...
//        searchSourceBuilder.aggregation(AggregationBuilders.terms("brandAgg").field("brand"));
////                .subAggregation(AggregationBuilders.terms("gender").field("gender")));
//        request.source(searchSourceBuilder);
//        SearchResponse search = client.search(request, RequestOptions.DEFAULT);
//        //获取数据时首先对classroom分桶，再对gender分桶
//        Terms classroomTerm = search.getAggregations().get("brandAgg");
...
//        }
    ...
    @Test
    public void autoAll() throws IOException {
        // 1.准备请求
        SearchRequest request = new SearchRequest("hotel");
        // 2.请求参数
